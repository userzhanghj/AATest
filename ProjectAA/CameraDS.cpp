...
IplImage* CCameraDS::QueryFrame()
{
	...
	memcpy(gSystemMgr.imgCap->bImgBuf, (long*)m_pFrame->imageData, m_nBufferSize);
	cvFlip(m_pFrame);
...
int CameraDs::run()
{
	...
	iImgWidth = gSystemMgr.CameraDsW; //m_nWidth; m_nHeight
	iImgHeight = gSystemMgr.CameraDsH;
